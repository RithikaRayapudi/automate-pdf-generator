...
<div class="h-screen  mt-20  flex flex-wrap items-center  justify-center pb-12 ">
            <div class="container lg:w-2/6 xl:w-2/7 sm:w-full md:w-2/3 mb-10 fixed w-full z-50 bg-slate-300 bg-white  shadow-lg    transform   duration-200 easy-in-out ">
                ...
                <div class="flex justify-center px-5  -mt-12">
                    <img class="h-32 w-32 bg-white p-2 rounded-full " src="https://tse3.mm.bing.net/th?id=OIP.0rQG7sTm_atLa371HSj23AHaHa&pid=Api&P=0&h=180" alt="" />
                </div>
                <div class=" ">
                    <div class="text-center px-14">
                        <h2 class="text-gray-800 text-3xl font-bold">ACM VNRVJIET</h2>
                        <a class="text-gray-400 mt-2 hover:text-blue-500" href="https://www.instagram.com/acm_vnrvjiet/" target="BLANK()">@acm_vnrvjiet</a>
